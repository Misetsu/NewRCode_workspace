...
function submitJPG() {
    ...
    var url = document.getElementById("jpgURL").value;
    ...
    $.ajax({
        type: "POST",
        url: "/jpgtest",
        data: JSON.stringify(server_data1),
        contentType: "application/json",
        dataType: 'json',
        success: function (result) {
            window.location.href = "/result/images/" + result['imageId'];
        }
    });
}
